...
{% include callout.liquid content="
...
<div class="projects">
    <h2 class="category">Preprints & Under Review</h2>
</div>


{% include publication_card.liquid 
  title="Topic: Efficient AI Agent"
  authors="**Jeonghoon Park**, Mingyu Kim, Hojun Lee, Taesik Gong"
  venue="Under review at Top conf."
%}

<br><br>

<!-- <div class="projects">
    <h2 class="category">Conferences & Journals</h2>
</div>

<br><br>

<div class="projects">
    <h2 class="category">Workshops, Posters, Demos, and Videos</h2>
</div> -->
