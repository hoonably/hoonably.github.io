...
{% include figure.liquid loading="eager" path="files/2000-images/image3.webp" class="img-fluid rounded z-depth-1" zoomable=true %}
---
...
{% include figure.liquid loading="eager" path="files/2000-images/image4.webp" class="img-fluid rounded z-depth-1" zoomable=true %}image
