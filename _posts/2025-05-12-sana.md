...
[250501_JeonghoonPark_SANA_Efficient_High-Resolution.pdf](/files/2025-05-12-sana/250501_JeonghoonPark_SANA_Efficient_High-Resolution.pdf)

[250501_JeonghoonPark_SANA_Efficient_High-Resolution.pptx](/files/2025-05-12-sana/250501_JeonghoonPark_SANA_Efficient_High-Resolution.pptx)

{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%201.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%202.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%203.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%204.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%205.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%206.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%207.png" class="img-fluid rounded z-depth-1" zoomable=true %}

Softmax는 모든 Query-Token 조합을 다 계산하기 때문에 O(N²) 복잡도가 발생

{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%208.png" class="img-fluid rounded z-depth-1" zoomable=true %}

- SANA에서는 다음처럼 계산 구조를 변경:
    1. 각 Key에 ReLU를 적용함: **ReLU(K)**
    2. 두 가지 공유 term을 미리 계산
        
        {% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%209.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2010.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2011.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2012.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2013.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2014.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2015.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2016.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2017.png" class="img-fluid rounded z-depth-1" zoomable=true %}

{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2018.png" class="img-fluid rounded z-depth-1" zoomable=true %}

{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2019.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2020.png" class="img-fluid rounded z-depth-1" zoomable=true %}

{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2021.png" class="img-fluid rounded z-depth-1" zoomable=true %}

{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2022.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2023.png" class="img-fluid rounded z-depth-1" zoomable=true %}

{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2024.png" class="img-fluid rounded z-depth-1" zoomable=true %}

# Limitation

{% include figure.liquid loading="eager" path="files/2025-05-12-sana/image%2025.png" class="img-fluid rounded z-depth-1" zoomable=true %}
